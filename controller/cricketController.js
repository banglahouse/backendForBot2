...
module.exports.getAllCricketWebsite = async function getAllWebsite(req, res) {
  
    let allWebsites = await cricketModel.find();
...
module.exports.deleteWebsite = async function deleteWebsite(req, res) {
 ...
 try{  
    let website = await cricketModel.findByIdAndDelete(dataToBeDeleted)
    console.log(website)
    res.json({
...
module.exports.deleteManyWebsites = async function deleteManyWebsite(req, res) {
    ...
    console.log(dataToBeDeleted);
 try{  
    let website = await cricketModel.deleteMany({_id:{$in:dataToBeDeleted}})
    console.log(website)
    res.json({
        message: 'data deleted successfully',
        data: website
