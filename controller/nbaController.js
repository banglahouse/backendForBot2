...
const nbaModel = require('../Model/nbaModel');
// const tennisModel = require('../Model/tennismodel');


module.exports.getAllNBAWebsites = async function getAllWebsite(req, res) {
  
    let allWebsites = await nbaModel.find();
...
module.exports.deleteWebsite = async function deleteWebsite(req, res) {
 ...
 try{  
    let website = await nbaModel.findByIdAndDelete(dataToBeDeleted)
    console.log(website)
    res.json({
...
module.exports.deleteManyWebsites = async function deleteManyWebsite(req, res) {
    ...
    console.log(dataToBeDeleted);
 try{  
    let website = await nbaModel.deleteMany({_id:{$in:dataToBeDeleted}})
    console.log(website)
    res.json({
        message: 'data deleted successfully',
        data: website
